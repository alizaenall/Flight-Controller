...
void setup() {
  ...
  LoopTimer=micros();
  Serial.println("START LOGGING M1");
  // displayInstructions();
...
void userInput(){
  if (Serial.available()) {
      ...
      switch (data) {
          ...
          break;
          // 4
          case 52 : //Serial.println("Throttle : 1200");
                    input_throttle = 1200;
                    //Serial.println(input_throttle);
          break;
          // 5
          case 53 : //Serial.println("Throttle : 1300");
                    input_throttle = 1300;
                    //Serial.println(input_throttle);
          break;
          // 6
          case 54 : //Serial.println("Add + 100us");
                    input_throttle = input_throttle + 50;
                    //Serial.println(input_throttle);
          break;
          // 7
          case 55 : //Serial.println("Subtract - 100us");
                    input_throttle = input_throttle - 50;
                    //Serial.println(input_throttle);
          break;
          // 8
